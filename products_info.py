...
class ProductInfo:
    ...
    def get_holding_stk(self,date=None):
        ...
        with da.DatabaseAssistant(dbdir=self._stddbdir) as stddb:
            ...
            if self._prodname=='ls1':
                print('ls1 stock values :', stkval)
    ...
    def get_holding_fut(self,date=None,margin=0.3):
        ...
        with da.DatabaseAssistant(dbdir=self._stddbdir) as stddb:
            ...
            if self._prodname=='ls1':
                print('ls1 futures values :', futval)
...
if __name__=='__main__':
    # t = pd.DataFrame([['000001',1],['000002',2]],columns=['stkcd','val'])
    # t2 = pd.DataFrame([['000001',5],['000003',6]],columns=['stkcd','val2'])
    # print(t.merge(t2,left_on='stkcd',right_on='stkcd',how='left'))
